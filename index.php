...
<script src="https://app.sandbox.midtrans.com/snap/snap.js" data-client-key="SB-Mid-client-fxByMERqCaioLeRq"></script>
<script type="text/javascript">
  ...
  */
  function getSnapToken(requestBody, callback) {
    ...
    xmlHttp.open("post", "http://localhost/midtranstestlagi/checkout.php");
